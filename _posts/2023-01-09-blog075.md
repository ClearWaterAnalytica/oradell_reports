...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230109/Fig_prediction.png)
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230109/Fig_chla.png){: .align-center}
<br clear="all" />
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230109/Fig_cyan.png){: .align-center}
<br clear="all" />
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230109/Fig_climatology.png){: .     align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230109/Fig_precip_cumsum.png){: .     align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230109/Fig_temp_cumsum.png){: .     align-center}
