...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220428/Fig_prediction.png)
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220428/Fig_chla_week.png){:             width="600px"}{: .align-center}
<br clear="all" />
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220428/Fig_cyan.png){: width="600px"}{: .align-center}
<br clear="all" />
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220428/Fig_climatology.png){: .     align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220428/Fig_precip_cumsum.png){: .     align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20220428/Fig_temp_cumsum.png){: .     align-center}
