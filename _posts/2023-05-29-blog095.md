...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230529/Fig_prediction.png)
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230529/Fig_chla.png){: .align-center}
<br clear="all" />
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230529/Fig_cyan.png){: .align-center}
<br clear="all" />
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230529/Fig_climatology.png){: .     align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230529/Fig_precip_cumsum.png){: .     align-center}
...
![image-center]({{ site.url }}{{ site.baseurl }}/assets/images/20230529/Fig_temp_cumsum.png){: .     align-center}
